...
expected={"contract.production.json","menhir_scaffold.py","menhir_app_only.py","menhir_security_config.py","menhir-scaffold-audit.service","menhir-scaffold-audit.timer","menhir-scaffold.sudoers","install.sh"}
...
install -o root -g root -m 0755 "${bundle}/menhir_security_config.py" /srv/menhir/scaffold/bin/menhir_security_config.py
