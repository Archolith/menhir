...
|---|---|
| [`menhir-oauth-refresh-chatgpt-integration-plan.md`](menhir-oauth-refresh-chatgpt-integration-plan.md) | Close the current ChatGPT web MCP compatibility contract: transport, client identity, OAuth signaling/refresh, complete tool metadata, and real end-to-end proof against `/mcp-http`. |
