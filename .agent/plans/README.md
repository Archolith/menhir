...
| [`menhir-release-automation-2026-09-06.md`](menhir-release-automation-2026-09-06.md) | Replace one-off release workspaces with validated change fragments, deterministic notes, maintained bundle construction, and a resumable coordinator that preserves review and deployment approval gates. |
