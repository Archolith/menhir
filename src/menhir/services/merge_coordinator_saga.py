"""MergeCoordinator implementation, moved verbatim from ``merge_coordinator`` (the facade re-exports it)."""
...
# Moved from merge_coordinator; pin its logger namespace so log records stay attributable there.
logger = logging.getLogger("menhir.services.merge_coordinator")
