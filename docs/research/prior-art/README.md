...
**Staleness risk:** Athena-Public, M3 Memory, and TencentDB Agent Memory pin the exact public
revision analyzed, while the FluxMem paper link pins v1. Memtrace and Repowise capture only
Menhir's review date, and Atlaso is a dated product snapshot whose public connectors expose
only part of the system. Re-verify any unpinned or closed-system claims before using them in a
roadmap or positioning decision.
