...
POSITIVE_CASES = [
    ...
    ("my commute takes 45 minutes.",
     (("commute_duration", "duration", "absolute", "seconds", 2700, "my commute takes 45 minutes"),)),
    ("my workout lasts 45 minutes.",
     (("workout_duration", "duration", "absolute", "seconds", 2700, "my workout lasts 45 minutes"),)),
    ("my shift is 8 hours.", (("shift_duration", "duration", "absolute", "seconds", 28800,
                               "my shift is 8 hours"),)),
    ("I sleep 8 hours a night.", (("sleep_duration", "duration", "absolute", "seconds", 28800,
